...
#    n_mutator_mean, n_mutator_CI, n_antimut_mean, n_antimut_CI, pop_size_mean, pop_size_CI = restore_python_mean_CI()
...
#	fig = plt.figure(figsize=(30, 25))
	...
	plt.subplot(231)
	errorbar(range(0,n_gen),fitness_mean,fitness_CI,color='r',capsize=0,ecolor='gray')
	# yscale('log')
	title('Mean Fitness')
...
#	axvline(x=start,color='g')
	...
	plt.subplot(232)
	errorbar(range(0,n_gen),mutator_strength_mean,mutator_strength_CI,fmt='r',ecolor='gray',capsize=0)
#	 yscale('log',basey=2)
#	 yscale('log')
...
#	axvline(x=start,color='g')
	...
	plt.subplot(233)
	errorbar(range(0,n_gen),n_dele_mean,n_dele_CI,fmt='r',ecolor='gray',capsize=0)
...
#	axvline(x=start,color='g')
	...
	plt.subplot(234)
	errorbar(range(0,n_gen),n_bene_mean,n_bene_CI,fmt='r',ecolor='gray',capsize=0)
...
#	plt.subplot(335)
#	errorbar(range(0,n_gen),n_mutator_mean,n_mutator_CI,fmt='r',ecolor='gray',capsize=0)
#	title('Mean # of Mutator/Individual')
#	xlabel("Generation", fontsize=20)
#	ylabel("# of Mutator", fontsize=20)
#
#	plt.subplot(336)
#	errorbar(range(0,n_gen),n_antimut_mean,n_antimut_CI,fmt='r',ecolor='gray',capsize=0)
