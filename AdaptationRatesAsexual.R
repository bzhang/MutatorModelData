rm(list=ls())
library(segmented)
dataPath = "/Volumes/BigTwins/MutatorModelData/FixedMutationRates/"
setwd(dataPath)
...
output = paste(dataPath, "AdaptationRates_MeanSquaredErrors.txt", sep="")
sink(output)
# windowSize = 1000
# step = 10
# cmd_ngen1 = "echo "
